...
import datasets.test.test_dataset as dataset_desc
...
# pydevd_pycharm.settrace('localhost', port=33456, stdoutToServer=True, stderrToServer=True)
...
config = Config(ds_name='test', cls_type=args.cls)
